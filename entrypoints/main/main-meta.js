...
const UIStrings = {
    ...
    *@description Text in Main
    */
    dockSperate: 'Open Spereate Window',
    /**
    /**
...
UI.ActionRegistration.registerActionExtension({
    ...
    actionId: 'inspector_main.dock-sperate',
    async loadActionDelegate() {
        const InspectorMain = await loadInspectorMainModule();
        return InspectorMain.InspectorMain.DockSperateActionDelegate.instance();
    },
    order: 100,
    title: i18nLazyString(UIStrings.dockSperate),
    bindings: [
        {
